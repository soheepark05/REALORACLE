...
SELECT DEPARTMENT_NAME AS "학과명",
 ...
 AND SUBSTR(STUDENT_SSN, 8,1) = '2'             --주민번호 뒷자리 첫시작이 2인..
 AND ABSENCE_YN = 'Y';
...
-- 8번 
SELECT c1.class_no, c1.class_name, c1.preattending_class_no,c1.class_name
FROM TB_CLASS C1
...
select STUDENT_NO AS "학번"
    , STUDENT_NAME AS "이름",
    TO_CAHR(ENTRANCE_DATE, 'YYYY-MM-DD') AS "입학년도"
FROM TB_STUDENT
...
SELECT PROFESSOR_NAME,
    PROFESSOR_SSN
FROM TB_PROFESSOR
--(다른사람)WHERE LENGTH(PROFESSOR_NAME) != 3;
WHERE PROFESSOR_NAME NOT LIKE '___';

--3번
SELECT PROFESSOR_NAME AS "이름",  FLOOR(MONTHS_BETWEEN(SYSDATE,TO_DATE('19'||SUBSTR(PROFESSOR_SSN,1,2),'YYYY'))/12) AS "나이"
FROM TB_PROFESSOR
